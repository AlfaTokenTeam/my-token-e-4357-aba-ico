...
import "./MyTokenE4357ABA.sol";

contract MyTokenE4357ABAPreSale {
    MyTokenE4357ABA public token;
    ...
    function MyTokenE4357ABAPreSale(
        MyTokenE4357ABA _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenE4357ABA(_token);
